...
function ItemDetail({ product }) {
    ...
    const comprobarCarrito = resultado.comprobarCarrito;
        ...
        return (
            <Grid container justifyContent="center">
                ...
                <Grid item md={6} sm={10} flexDirection="column" justifyContent="center">
                    ...
                    <Typography variant="h5" textAlign="center">{product.price} Usd</Typography>
                    <Grid container justifyContent="center">
                        <Link to='/cart' onClick={() => comprobarCarrito(product, { cantidad })}><Button variant="contained">Agregar al carrito</Button></Link>
                    </Grid>
